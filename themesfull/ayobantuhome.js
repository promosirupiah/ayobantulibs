...
jQuery(function ($) {
    ...
    var bgimages = "url('http://cdn.ayobantu.net/themesfull/object0.png'), ".split(",");
    ...
    header.css('background-image', "url('http://cdn.ayobantu.net/themesfull/header.png')".replace(/(url\(['"]?)/i, "$1" + path));
